      ...
      <main className="bg-black/85 min-w-[306px] p-6 rounded-md text-white">
        ...
        <form className="space-y-5" onSubmit={handleRegister}>
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="username" className="text-xs font-medium tracking-wide">Username</label>
          ...
          <div className="flex flex-col gap-1 relative">
            <label htmlFor="password" className="text-xs font-medium tracking-wide">Kata Sandi</label>
          ...
          {/* Konfirmasi Password */}
          <div className="flex flex-col gap-1 relative">
            <label htmlFor="confirmPassword" className="text-xs font-medium tracking-wide">Konfirmasi Kata Sandi</label>
            <input type="password" id="confirm-password" name="confirmPassword" placeholder="Masukan kembali kata sandi"
              onChange={handleChange}
              className="bg-transparent text-sm px-3 py-2 border border-white/20 rounded-xl text-gray-300 focus:outline-none" />
          </div>

          <div className="text-[10px] text-gray-400 text-center">
            Sudah punya akun? <a href="/login" className="text-white underline">Masuk</a>
          </div>
