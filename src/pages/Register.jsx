...
import bgRegister from '../assets/images/background/bg-register.jpg'

export default function Register() {
  return (
    <div className="font-[Lato] w-screen h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url(bgRegister)'}} >
    <main className="bg-black/85 min-w-[306px] p-6 rounded-md text-white">
        <div className="flex flex-col items-center mb-6">
        <img className="w-[94px] h-[24px] mb-5" src="./images/logo/logo-chill.png" alt="logo-chill" />
        ...
        <button type="button"
            ...
            <img src="./images/logo/google-icon.png" alt="google-icon" className="w-3 h-3" />
